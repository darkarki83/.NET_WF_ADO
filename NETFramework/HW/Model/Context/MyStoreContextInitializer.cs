...
namespace HW.Model
{
    ...
    public class MyStoreContextInitializer : CreateDatabaseIfNotExists<MyStoreContext>
    {
        protected override void Seed(MyStoreContext context)
        {
            ...
            var parts = new Part[]
            {
                new Part { Id = 1, Name = "Электрический котел Roda Storm SL 8 - 7,5 кВт", Cost = 499, ManufacturerFk = manufacturers[0].Id, Count = 24 },
                new Part { Id = 2, Name = "Электрический котел Roda Storm SL 18 - 18 кВт", Cost = 527, ManufacturerFk = manufacturers[0].Id, Count = 24 },
                new Part { Id = 3, Name = "Электрический котел Roda Storm SL 15 - 15 кВт", Cost = 527, ManufacturerFk = manufacturers[0].Id, Count = 24 },
                new Part { Id = 4, Name = "Твердотопливный котёл Termomont ТКК3-25 кВт", Cost = 1453, ManufacturerFk = manufacturers[1].Id, Count = 24 },
                new Part { Id = 5, Name = "Твердотопливный котёл Termomont ТКU3-20 кВт", Cost = 1514, ManufacturerFk = manufacturers[1].Id, Count = 24 },
                new Part { Id = 6, Name = "Твердотопливный котёл Termomont ТКК3-30 кВт", Cost = 1574, ManufacturerFk = manufacturers[1].Id, Count = 24 },
                new Part { Id = 7, Name = "Твердотопливный котёл Termomont ТКU3-25 кВт", Cost = 1635, ManufacturerFk = manufacturers[1].Id, Count = 24 },
                new Part { Id = 8, Name = "Пеллетный котел Termomont TOBY 12В 12 кВт", Cost = 3269, ManufacturerFk = manufacturers[1].Id, Count = 24 },
                new Part { Id = 9, Name = "Пеллетный котел Termomont TOBY 12Н 12 кВт", Cost = 3451, ManufacturerFk = manufacturers[1].Id, Count = 24 },
                new Part { Id = 10, Name = "Пеллетная горелка Termomont Biotermec 50 (10-50 кВт)", Cost = 1639, ManufacturerFk = manufacturers[1].Id, Count = 24 },
                new Part { Id = 11, Name = "Пеллетная горелка Termomont Biotermec 100 (50-100 кВт)", Cost = 2795, ManufacturerFk = manufacturers[1].Id, Count = 24 },
                new Part { Id = 12, Name = "Пеллетная горелка Termomont Agrotermec 50 кВт", Cost = 3255, ManufacturerFk = manufacturers[1].Id, Count = 24 },
                new Part { Id = 13, Name = "Топливная емкость MAFA MINI-300", Cost = 605, ManufacturerFk = manufacturers[1].Id, Count = 24 },
                new Part { Id = 14, Name = "Топливная емкость MAFA MIDI-730", Cost = 1090, ManufacturerFk = manufacturers[1].Id, Count = 24 },
                new Part { Id = 15, Name = "Автоматический воздухоотводчик Honeywell E121-3/8A", Cost = 9, ManufacturerFk = manufacturers[2].Id, Count = 24 },
                new Part { Id = 16, Name = "Автоматический воздухоотводчик Honeywell E121-1/2A", Cost = 10, ManufacturerFk = manufacturers[2].Id, Count = 24 },
                new Part { Id = 17, Name = "Автоматический воздухоотводчик Spirovent Spirotop AAV AB050", Cost = 76, ManufacturerFk = manufacturers[3].Id, Count = 24 },
                new Part { Id = 18, Name = "Автоматический воздухоотводчик Spirotop AAV AB050/008", Cost = 115, ManufacturerFk = manufacturers[3].Id, Count = 24 },
                new Part { Id = 19, Name = "Автоматический воздухоотводчик Spirotop AAV AB050/002", Cost = 115, ManufacturerFk = manufacturers[3].Id, Count = 24 },
                new Part { Id = 20, Name = "Сепаратор воздуха SpiroVent Air AA075 3/4", Cost = 134, ManufacturerFk = manufacturers[3].Id, Count = 24 },
                new Part { Id = 21, Name = "Сепаратор воздуха Spirovent Air AA100 1", Cost = 142, ManufacturerFk = manufacturers[3].Id, Count = 24 },
                new Part { Id = 22, Name = "Гидравлическая стрелка SpiroCross DN50 (под приварку - сталь)", Cost = 1526, ManufacturerFk = manufacturers[3].Id, Count = 24 },
                new Part { Id = 23, Name = "Гидравлическая стрелка SpiroCross DN50 (фланец - сталь)", Cost = 1777, ManufacturerFk = manufacturers[3].Id, Count = 24 },
                new Part { Id = 24, Name = "Гидравлическая стрелка SpiroCross DN65 (под приварку - сталь)", Cost = 1780, ManufacturerFk = manufacturers[3].Id, Count = 24 },
                new Part { Id = 25, Name = "Гидравлическая стрелка SpiroCross DN65 (фланец - сталь)", Cost = 2062, ManufacturerFk = manufacturers[3].Id, Count = 24 }
            };
