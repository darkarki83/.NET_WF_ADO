...
#if CONSUMER
            Queue1 = new QueueClient(@"DefaultEndpointsProtocol=https;AccountName=tymko;AccountKey=jj/AT7NPx6l5Oms+PLvrMkyM6YM6zI8hBTML78yTVwHqzQIcxxvR4XdmcZtVucRNppSERij/HEkSCjLsTgyJUg==;EndpointSuffix=core.windows.net", "queue1");
